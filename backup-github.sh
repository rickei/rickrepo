...
GHBU_BACKUP_DIR=${GHBU_BACKUP_DIR-"githubbackup"}                  # where to place the backup files
GHBU_ORG=${GHBU_ORG-"organ_name"}                                   # the GitHub organization whose repos will be backed up
